...
private:
	...
	std::vector<std::string>		_allowMethods;			// [OPTIONAL] if empty, fallback to default: GET, POST, DELETE
	...
	size_t							_keepAliveTimeout;		// [OPTIONAL] default: 60s
...
public:
	ServerConfig();											// will override by DefaultConfig
	~ServerConfig();
